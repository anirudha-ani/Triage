...
public class GameAssets {
    ...
    public void LoadResources() {
        ...
        Image spaceBackground2 = new Image("file:triage/spritesheets/backgrounds/SpaceBackground2.jpg", 1602, 1024, false, true);
        ...
        gameResource.addSpriteSheet(SpriteSheetId.BACKGROUND_PLATFORM.toString(), spaceBackground,1, 1, 1602, 1024);
